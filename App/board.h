...
#define ONBOARD_SENSOR_I2C_PORT  	GPIOB
#define ONBOARD_SENSOR_I2C_SDA     	LL_GPIO_PIN_9
#define ONBOARD_SENSOR_I2C_SCL    	LL_GPIO_PIN_8

#define CHARGER_I2C_HANDLE   		I2C2
#define CHARGER_SENSOR_I2C_IRQ      I2C2_EV_IRQn
#define CHARGER_SENSOR_I2C_PORT		GPIOB
#define CHARGER_SENSOR_I2C_SDA		LL_GPIO_PIN_11
#define CHARGER_SENSOR_I2C_SCL		LL_GPIO_PIN_10

#define SENSOR_I2C_HANDLE           I2C3
#define SENSOR_I2C_IRQ              I2C3_EV_IRQn
#define SENSOR_I2C_PORT_SDA 		GPIOC
#define SENSOR_I2C_PORT_SCL 		GPIOA
#define SENSOR_I2C_SDA     			LL_GPIO_PIN_9
#define SENSOR_I2C_SCL    			LL_GPIO_PIN_8
