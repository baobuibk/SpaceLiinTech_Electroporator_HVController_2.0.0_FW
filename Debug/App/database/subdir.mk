...
C_SRCS += \
../App/database/db_cap_controller.c \
../App/database/db_sensor.c 

OBJS += \
./App/database/db_cap_controller.o \
./App/database/db_sensor.o 

C_DEPS += \
./App/database/db_cap_controller.d \
./App/database/db_sensor.d 


# Each subdirectory must supply rules for building sources it contributes
App/database/%.o App/database/%.su App/database/%.cyclo: ../App/database/%.c App/database/subdir.mk
...
clean: clean-App-2f-database

clean-App-2f-database:
	-$(RM) ./App/database/db_cap_controller.cyclo ./App/database/db_cap_controller.d ./App/database/db_cap_controller.o ./App/database/db_cap_controller.su ./App/database/db_sensor.cyclo ./App/database/db_sensor.d ./App/database/db_sensor.o ./App/database/db_sensor.su

.PHONY: clean-App-2f-database
