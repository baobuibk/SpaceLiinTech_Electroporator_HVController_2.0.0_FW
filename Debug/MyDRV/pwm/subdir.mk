...
MyDRV/pwm/%.o MyDRV/pwm/%.su MyDRV/pwm/%.cyclo: ../MyDRV/pwm/%.c MyDRV/pwm/subdir.mk
...
clean: clean-MyDRV-2f-pwm

clean-MyDRV-2f-pwm:
	-$(RM) ./MyDRV/pwm/pwm.cyclo ./MyDRV/pwm/pwm.d ./MyDRV/pwm/pwm.o ./MyDRV/pwm/pwm.su

.PHONY: clean-MyDRV-2f-pwm
