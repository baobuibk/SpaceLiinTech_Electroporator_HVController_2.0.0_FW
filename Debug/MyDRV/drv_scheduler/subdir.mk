...
C_SRCS += \
../MyDRV/drv_scheduler/scheduler.c 

OBJS += \
./MyDRV/drv_scheduler/scheduler.o 

C_DEPS += \
./MyDRV/drv_scheduler/scheduler.d 


# Each subdirectory must supply rules for building sources it contributes
MyDRV/drv_scheduler/%.o MyDRV/drv_scheduler/%.su MyDRV/drv_scheduler/%.cyclo: ../MyDRV/drv_scheduler/%.c MyDRV/drv_scheduler/subdir.mk
...
clean: clean-MyDRV-2f-drv_scheduler

clean-MyDRV-2f-drv_scheduler:
	-$(RM) ./MyDRV/drv_scheduler/scheduler.cyclo ./MyDRV/drv_scheduler/scheduler.d ./MyDRV/drv_scheduler/scheduler.o ./MyDRV/drv_scheduler/scheduler.su

.PHONY: clean-MyDRV-2f-drv_scheduler
